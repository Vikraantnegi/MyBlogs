            ...
            <div className="MyBlogs_HomeContainer">
                <div className="MyBlogs_BlogContainer">
                    ...
                    <div className="BlogContent">
                        <div className="BlogContent__title">{data.title}</div>
                        <div className="BlogContent__extras">
                            <div className="BlogContent__date"><span className="bold">Posted Date :</span>{data.added_date}</div>
